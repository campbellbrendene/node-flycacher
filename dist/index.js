...
var Flycacher = /** @class */ (function () {
     ...
     */
    function Flycacher(missCallback, options) {
    ...
    Flycacher.prototype.clear = function () {
        this.values.clear();
    };
    Flycacher.prototype["delete"] = function (key) {
        this.values["delete"](key);
    };
    Flycacher.prototype.get = function (key) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.prune();
                        hit = this.values.get(key);
                        if (hit) {
                            return [2 /*return*/, hit.value];
                        }
                        return [4 /*yield*/, this.missCallback(key)];
                    case 1:
                        value = _a.sent();
    ...
    Flycacher.prototype.prune = function () {
        var e_1, _a, e_2, _b;
        if (this.values.size > this.capacity) {
            try {
                for (var _c = __values(this.values.keys()), _d = _c.next(); !_d.done; _d = _c.next()) {
                    var key = _d.value;
                    this.values["delete"](key);
        ...
        if (this.ttl && this.values.size > 0 && this.ttl > 0) {
            ...
            if (this.oldest < expiry) {
                try {
                    for (var _e = __values(this.values), _f = _e.next(); !_f.done; _f = _e.next()) {
...
module.exports = Object.assign(Flycacher, { "default": Flycacher, Flycacher: Flycacher });
